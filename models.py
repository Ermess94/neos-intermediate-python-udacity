...
class NearEarthObject:
    ...
    def __init__(self, designation: str, name: str, diameter: float, hazardous: bool):
        ...
        self.diameter: float = float(
            diameter) if diameter is not None else float('nan')
        self.hazardous: bool = hazardous if hazardous is not None else False
    ...
    def __str__(self):
        """Return `str(self)`."""
        return f"NEO {self.fullname} has a diameter of {self.diameter:.3f} km and {'is' if self.hazardous == True else 'is not'} potentially hazardous."
...
class CloseApproach:
    ...
    def __init__(self, designation: str, time: str, distance: float, velocity: float):
        ...
        self.velocity: float = float(
            velocity) if velocity is not None else float('nan')
    ...
    def time_str(self):
        ...
        """
        return datetime_to_str(self.time) if self.time != None else None
